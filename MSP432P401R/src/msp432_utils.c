...
//
//*****************************************************************************
void drawImageMeterInit(Graphics_Context *g_sContext)
{

    Graphics_drawImage(g_sContext, &meterInit4BPP_UNCOMP, 0, 0);
    Graphics_drawCircle(g_sContext, 9, 117, 5);
...
//*****************************************************************************
//
//! Draws the background image of the meter during the measurement.
//
//*****************************************************************************
void drawImageMeterMeasure(Graphics_Context *g_sContext)
{

    Graphics_drawImage(g_sContext, &meterMeasure4BPP_UNCOMP, 0, 0);
    Graphics_drawCircle(g_sContext, 9, 117, 5);
}
